...
echo "The cleanup script is commented for mcp/pike branch:  this is to prevent
running cleanup script at the upgraded Production clouds (e.g. JPE4, JPE3)
from Ocata to Pike. Uncomment it if needed."
